...
public class AnalyticsManager 
{
    ...
    public static void LogUpgradeEvent (int resourceIndex, int level)
    {
        ...
        LogEvent
        ( FirebaseAnalytics.EventLevelUp, new Parameter (FirebaseAnalytics.ParameterIndex, resourceIndex.ToString ()), new Parameter (FirebaseAnalytics.ParameterLevel, level) );
